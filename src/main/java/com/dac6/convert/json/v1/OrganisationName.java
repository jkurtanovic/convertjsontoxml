...
public class OrganisationName {
    ...
    public String toString() {
        ...
        sb.append(OrganisationName.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
        sb.append(((this.name == null)?NULL_V:this.name));
        sb.append(',');
